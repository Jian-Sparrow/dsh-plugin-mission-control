...
export const en = {
  ...
  'panel.connecting': 'Connecting to live mission telemetry…',
  'panel.noSession': 'Select a Session to watch its live activity.',
...
export const zh: Record<MissionControlKey, string> = {
  ...
  'action.open': '打开任务控制台',
  'panel.close': '关闭任务控制台',
  'panel.connecting': '正在连接实时任务遥测…',
  'panel.noSession': '请选择一个会话以查看其实时活动。',
